...
var pie = ["apple", "cherry", "key lime", "huckleberry"];
console.log(pies);
...
var favoriteFoods = ["cereal, pizza, tacos, sandwich, chicken, hotdogs, soup"];
...
console.log("The length of Days of the week array is " + daysOfTheWeek.length)
...
//1. creats function named returnLastElement
//2. this function accepts an array
//3. get the last item in an array by using array.length - 1
...
for(var i = 0; i < shapes.length; i++){
    console.log("=============");//<==== just being used to make a line in the code to seperate
    console.log("current iteration: " + i);
    console.log(shapes[i]);
    //shapes[0] - iteration 1
    //shapes[1] - iteration 2
    //shapes[2] - iteration 3
    //shapes[3] - iteration 4
}
...
for(var i = 0; i < instructors.length; i++){
    if (instructors[i] === "vivian" || instructors[i] === 'sophie') {
        ...
        console.log("I have not had class with that " + instructors[i] + " yet!");
    }
}
