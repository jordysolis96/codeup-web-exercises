...
var weShouldDeleteStuff = confirm ("are you sure you wnat to delete everything?")//boolean

// ok slection ==> true, cnacel selection ==> false
...
console.log(checkWeather("windy"));//should see have a nice day
console.log(checkWeather("sunny"));//should see have a nice day
console.log(checkWeather("Snowing"));//should see it's snowing
...
console.log(checkInersectionLight("red"));// stop
console.log(checkInersectionLight("blinking"));// caution
console.log(checkInersectionLight("green"));// proceed
